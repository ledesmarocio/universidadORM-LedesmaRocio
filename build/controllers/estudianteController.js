...
exports.eliminar = exports.modificar = exports.insertar = exports.consultarUno = exports.listarEstudiantes = exports.consultarTodos = exports.validar = void 0;
...
const validar = () => [
    (0, express_validator_1.check)('dni')
        ...
        .isNumeric().withMessage('El DNI del estudiante debe ser un número'),
    (0, express_validator_1.check)('nombre').notEmpty().withMessage('El nombre es obligatorio')
        .isLength({ min: 3 }).withMessage('El Nombre debe tener al menos 3 caracteres')
        .matches(/^[a-zA-Z\s]+$/).withMessage('El nombre del estudiante solo puede contener letras'),
...
const listarEstudiantes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const estudianteRepository = conexion_1.AppDataSource.getRepository(EstudianteModel_1.Estudiante);
...
exports.listarEstudiantes = listarEstudiantes;
